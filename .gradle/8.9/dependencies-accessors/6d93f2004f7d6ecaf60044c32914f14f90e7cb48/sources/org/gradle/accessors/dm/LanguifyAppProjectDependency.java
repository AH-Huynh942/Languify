...
@NonNullApi
public class LanguifyAppProjectDependency extends DelegatingProjectDependency {

    @Inject
    public LanguifyAppProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
